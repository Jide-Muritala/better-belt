...
const $$Index$1 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index$1;
  const allPosts = await Astro2.glob(/* #__PURE__ */ Object.assign({"../posts/post-1.md": () => import('./post-1_DNxfNsYd.mjs').then(n => n.p),"../posts/post-2.md": () => import('./post-2_EV3-5lxt.mjs'),"../posts/post-3.md": () => import('./post-3_CVY4Y0gr.mjs'),"../posts/post-4.md": () => import('./post-4_R3NrLljX.mjs')}), () => "../posts/*.md");
...
}, "/workspaces/better-belt/src/pages/tags/index.astro", void 0);

const $$file$1 = "/workspaces/better-belt/src/pages/tags/index.astro";
const $$url$1 = "/tags";
